...
const _HOME_GREETING_POOL = [
  { plain: `📖 היום זה יום מצוין לקרוא עוד קצת!`,          nk: `📖 הַיּוֹם זֶה יוֹם מְצֻיָּן לִקְרוֹא עוֹד קְצָת!` },
  { plain: `🌳 בואו נראה כמה העץ של הכיתה יגדל היום!`,      nk: `🌳 בּוֹאוּ נִרְאֶה כַּמָּה הָעֵץ שֶׁל הַכִּתָּה יִגְדַּל הַיּוֹם!` },
  { plain: `✨ כל עמוד הוא הרפתקה חדשה — מוכנים להתחיל?`,   nk: `✨ כָּל עַמּוּד הוּא הַרְפַּתְקָה חֲדָשָׁה — מוּכָנִים לְהַתְחִיל?` },
  { plain: `🎈 מוכנים לסיפור הבא?`,                         nk: `🎈 מוּכָנִים לַסִּפּוּר הַבָּא?` },
  { plain: `🌟 היום הוא יום מעולה לקרוא ולהוסיף נקודות לכיתה!`,  nk: `🌟 הַיּוֹם הוּא יוֹם מְעֻלֶּה לִקְרוֹא וּלְהוֹסִיף נְקֻדּוֹת לַכִּתָּה!` },
];

function pickHomeGreetingMessage() {
  const item = _HOME_GREETING_POOL[_dayIndex() % _HOME_GREETING_POOL.length];
