...
(function(){
  ...
  const files=[
    ...
    'roster-photo.js?v=20260916-photo-first',
    'teacher-roster.js?v=20260916-photo-first',
  ...
  function next(){
    ...
    s.onload=next;s.onerror=()=>{console.error('[booki] pilot module failed:',src);next();};
